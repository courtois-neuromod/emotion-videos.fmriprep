...
#SBATCH --job-name=fmriprep_study-cneuromod.emotion-videos_sub-01_ses-001.job
#SBATCH --output=/lustre10/scratch/bpinsard/cneuromod.emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-001.out
#SBATCH --error=/lustre10/scratch/bpinsard/cneuromod.emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-001.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-001_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-001 ; fi 
