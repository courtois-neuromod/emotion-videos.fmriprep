...
#SBATCH --job-name=fmriprep_study-cneuromod.emotion-videos_sub-01_ses-007.job
#SBATCH --output=/lustre10/scratch/bpinsard/cneuromod.emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-007.out
#SBATCH --error=/lustre10/scratch/bpinsard/cneuromod.emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-01_ses-007.err
