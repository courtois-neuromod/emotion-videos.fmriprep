...
#SBATCH --output=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-03_ses-001.out
#SBATCH --error=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-03_ses-001.err
