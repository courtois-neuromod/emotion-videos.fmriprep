...
#SBATCH --output=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-05_ses-004.out
#SBATCH --error=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-05_ses-004.err
