...
#SBATCH --output=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-06_ses-003.out
#SBATCH --error=/lustre04/scratch/bpinsard/emotion-videos.fmriprep/code/fmriprep_study-cneuromod.emotion-videos_sub-06_ses-003.err
